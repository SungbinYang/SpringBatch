...
import me.sungbin.batch.part4.LevelUpJobExecutionListener;
import me.sungbin.batch.part4.SaveUserTasklet;
import me.sungbin.batch.part4.User;
import me.sungbin.batch.part4.UserRepository;
import me.sungbin.batch.part5.JobParametersDecide;
import me.sungbin.batch.part5.OrderStatistics;
...
public class PartitionUserConfiguration {
    ...
    private ItemWriter<? super OrderStatistics> orderStatisticsItemWriter(String date) throws Exception {
        ...
        String fileName = yearMonth.getYear() + "년_" + yearMonth.getMonthValue() + "월_일별_주문_금약.csv";

        BeanWrapperFieldExtractor<OrderStatistics> fieldExtractor = new BeanWrapperFieldExtractor<>();
        fieldExtractor.setNames(new String[]{"amount", "date"});

        DelimitedLineAggregator<OrderStatistics> delimitedLineAggregator = new DelimitedLineAggregator<>();
    ...
    private ItemReader<? extends OrderStatistics> orderStatisticsItemReader(String date) throws Exception {
        ...
        JdbcPagingItemReader<OrderStatistics> jdbcPagingItemReader = new JdbcPagingItemReaderBuilder<OrderStatistics>()
